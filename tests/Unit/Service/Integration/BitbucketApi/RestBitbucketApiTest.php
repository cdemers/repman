...
final class RestBitbucketApiTest extends TestCase
{
    ...
    public function testFetchRepositories(): void
    {
        ...
        $repos->method('workspaces')->willReturnMap([
            ['repman', $workspaceOne],
            ['buddy', $workspaceTwo],
        ]);
        $this->pagerMock->method('fetchAll')->willReturnOnConsecutiveCalls(
            [
                ['workspace' => ['slug' => 'repman']],
                ['workspace' => ['slug' => 'buddy']],
            ],
            [
                [
            ...
            [
                [
                    ...
                    'links' => ['html' => ['href' => 'https://bitbucket.org/repman/right-pad']],
                ],
            ]
        );
        ...
        self::assertEquals(new Repositories([
            ...
            new Repository('74fb57b9-0820-4165-bba0-892eef8f69b8', 'repman/right-pad', 'https://bitbucket.org/repman/right-pad.git'),
